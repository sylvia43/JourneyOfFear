...
public enum AnimationLibrary {
    ...
    BLOB_GREEN_RIGHT(ImageLibrary.BLOB_GREEN_RIGHT,332,16,16), 
    BLOB_GREEN_UP(ImageLibrary.BLOB_GREEN_UP,332,16,16),
    BLOB_GREEN_DOWN(ImageLibrary.BLOB_GREEN_DOWN,332,16,16),
    BLOB_GREEN_LEFT(ImageLibrary.BLOB_GREEN_LEFT,332,16,16),
